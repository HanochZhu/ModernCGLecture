...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    // std::cout<<"TODO find ray triangle intersection"<<std::endl;
    inter.happened = true;
    inter.coords = (1 - u - v) * v0 + u * v1 + v * v2;
    inter.normal = normal;
    Vector3f distanceVector = ray.origin - inter.coords;
    inter.distance = sqrt(dotProduct(distanceVector,distanceVector));
    inter.m = m;
    inter.obj = this;
